...
export default function Dashboard() {
  ...
  useEffect(() => {
    Promise.all([fetchOverview(), fetchSummary()])
      ...
      .catch(() => {
        setError(
          "No se pudo conectar con el backend. Asegurate de que Spring Boot esta corriendo en http://localhost:8080",
        );
        setLoading(false);
      });
  }, []);
  ...
  return (
    <div className="dashboard">
      ...
      <p className="dashboard-subtitle">
        Metricas de rendimiento del equipo de desarrollo
      </p>
      ...
      <div className="metrics-grid">
        <MetricCard
          ...
          subtitle="Todos los desarrolladores"
          color="#4f46e5"
        />
        <MetricCard
        ...
        <MetricCard
          ...
          value={overview?.totalLinesAdded}
          subtitle="Lineas anadidas"
          color="#ef4444"
        />
        <MetricCard
